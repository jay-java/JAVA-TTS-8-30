...
<body class="animsition">
	...
	<header>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li><a href="#">Category</a>
								<ul class="sub-menu">
									<li><a href="seller-upload-product.jsp">Electronics</a></li>
									<li><a href="seller-manage-product.jsp">Furniture</a></li>
									<li><a href="seller-manage-product.jsp">Fashion</a></li>
									<li><a href="seller-manage-product.jsp">Footware</a></li>
								</ul></li>

							<li><a href="#">Welcome, <%=s.getName()%></a>
								<ul class="sub-menu">
									<li><a href="customer-profile.jsp">Profile</a></li>
									<li><a href="customer-change-pass.jsp">Change Password</a></li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index-2.html"><img src="images/icons/logo-01.png"
					alt="IMG-LOGO"></a>
			</div>
			...
			<ul class="main-menu-m">
				...
				<li><a href="#">Seller</a>
					<ul class="sub-menu-m">
						...
						<li><a href="home-02.html">Login</a></li>
	...
	<script defer
		...
		data-cf-beacon='{"rayId":"96a3547c1cb603e3","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"cd0b4b3a733644fc843ef0b185f98241","b":1}'
