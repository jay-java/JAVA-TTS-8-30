			...
			<div class="row">
							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3"
									...
									<div class="wrap-pic-w pos-relative">
										<img src="pimges/<%=p.getImage()%>" alt="IMG-PRODUCT"> <a
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<h4 class="mtext-105 cl2 js-name-detail p-b-14"><%=p.getPname()%></h4>

						<span class="mtext-106 cl2"> Rs.<%=p.getPprice()%>
						</span>

						<p class="stext-102 cl3 p-t-23"><%=p.getPdesc()%></p>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<a
										href="Wishlist?action=add&pid=<%=p.getPid()%>&cid=<%=s.getId()%>"
